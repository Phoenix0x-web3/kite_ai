...
class CloudflareHandler:
            ...
            try:
                ...
                if resp.status_code == 200:
                    ...
                    if result['status'] == 'ready':
                        ...
                        logger.error(f"{self.browser.wallet} solution does not contain gRecaptchaResponse")
                        return None
    ...
    async def get_recaptcha_task_v2(self, websiteURL: str, websiteKey: str) -> Optional[int]:
        """
        Create task for solving Cloudflare Turnstile in CapMonster
